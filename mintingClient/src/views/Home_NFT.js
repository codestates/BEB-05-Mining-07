...
const Home_NFT = () => {
  const PostsListFour = [
    {
      backgroundImage: require("../images/content-management/diamondPickAxe.png"),
      profile_image: require("../images/content-management/minting-lofo-removebg-preview.png"),
      author: "DevOwner",
      name: "MiningMincraftPrime"
    }
  ];
  return (
